...
interface TunnelErrorRateChartProps {
  timeRange: string
}

export function TunnelErrorRateChart({ timeRange }: TunnelErrorRateChartProps) {
                  ...
                  <div className="rounded-lg border bg-background p-2 shadow-sm">
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="font-bold text-destructive">{payload[0].value}%</span>
                      </div>
                    </div>
                  </div>
                )

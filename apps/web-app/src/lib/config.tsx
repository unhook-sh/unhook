    ...
    items: [
      {
        ...
        description:
          'Monitor webhook requests in real-time. Inspect payloads, headers, and routing information.',
      },
      {
        id: 2,
      ...
      },
      {
        ...
        description:
          'Track webhook activity across your team. Understand usage patterns and identify potential issues.',
      },
      {
        id: 4,
        ...
        title: 'Smart Routing',
        description:
          'Automatically route webhooks to the right developer based on active sessions and routing rules.',
      },
    ],
  },
  benefits: [
  ...
  faqSection: {
    ...
    faQitems: [
      ...
      },
      {
        ...
        answer:
          'Yes, Unhook implements end-to-end encryption for all webhook traffic. Your data is protected from unauthorized access and data leakage.',
      },
      {
        id: 4,
        question: 'Can I integrate with existing tools?',
        answer:
          'Yes, Unhook is designed to be highly compatible with popular tools and platforms. We offer APIs and pre-built integrations for seamless connection with your existing workflow tools and systems.',
      },
      {
        id: 5,

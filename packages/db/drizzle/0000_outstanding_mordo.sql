...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "forwardingDestinations" (
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "forwardingExecutions" (
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "webhookAccessRequests" (
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    "expiresAt" timestamp with time zone NOT NULL,
    "id" varchar(128) PRIMARY KEY NOT NULL,
    "orgId" varchar DEFAULT auth.jwt()->>'org_id' NOT NULL,
...
DO $$ BEGIN
    ALTER TABLE "events" ADD COLUMN "apiKeyId" varchar(128) DEFAULT '';
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "events" ADD COLUMN "failedReason" text;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "events" ADD COLUMN "maxRetries" integer DEFAULT 3 NOT NULL;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "events" ADD COLUMN "originRequest" json NOT NULL DEFAULT '{}'::json;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "events" ADD COLUMN "retryCount" integer DEFAULT 0 NOT NULL;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "events" ADD COLUMN "source" text DEFAULT '*' NOT NULL;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "events" ADD COLUMN "status" "eventStatus" DEFAULT 'pending' NOT NULL;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
...
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "events" ADD COLUMN "webhookId" varchar(128) NOT NULL DEFAULT '';
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
-- Add missing columns for other tables that might need them
DO $$ BEGIN
    ALTER TABLE "requests" ADD COLUMN "apiKeyId" varchar(128) DEFAULT '';
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "requests" ADD COLUMN "connectionId" varchar(128);
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "requests" ADD COLUMN "eventId" varchar(128);
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "requests" ADD COLUMN "destination" json NOT NULL DEFAULT '{}'::json;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "requests" ADD COLUMN "failedReason" text;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "requests" ADD COLUMN "request" json NOT NULL DEFAULT '{}'::json;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "requests" ADD COLUMN "response" json;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "requests" ADD COLUMN "responseTimeMs" integer DEFAULT 0 NOT NULL;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "requests" ADD COLUMN "source" text DEFAULT '*' NOT NULL;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
...
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "requests" ADD COLUMN "timestamp" timestamp with time zone NOT NULL DEFAULT now();
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "requests" ADD COLUMN "webhookId" varchar(128) NOT NULL DEFAULT '';
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
-- Add missing columns for webhooks table
DO $$ BEGIN
    ALTER TABLE "webhooks" ADD COLUMN "apiKeyId" varchar(128) DEFAULT '';
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "webhooks" ADD COLUMN "config" json DEFAULT '{"headers":{},"requests":{},"storage":{"maxRequestBodySize":1048576,"maxResponseBodySize":1048576,"storeHeaders":true,"storeRequestBody":true,"storeResponseBody":true}}'::json NOT NULL;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "webhooks" ADD COLUMN "isPrivate" boolean DEFAULT false NOT NULL;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
...
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "webhooks" ADD COLUMN "requestCount" integer DEFAULT 0 NOT NULL;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
    ALTER TABLE "webhooks" ADD COLUMN "status" "webhookStatus" DEFAULT 'active' NOT NULL;
EXCEPTION
    WHEN duplicate_column THEN null;
END $$;--> statement-breakpoint
-- Now add foreign key constraints
-- Temporarily disabled due to existing data issues
-- DO $$ BEGIN
...
-- Temporarily disabled due to existing data issues
-- DO $$ BEGIN
--     ALTER TABLE "webhooks" ADD CONSTRAINT "webhooks_apiKeyId_apiKeys_id_fk" FOREIGN KEY ("apiKeyId") REFERENCES "public"."apiKeys"("id") ON DELETE cascade ON UPDATE no action DEFERRABLE INITIALLY DEFERRED;
-- EXCEPTION
--     WHEN duplicate_object THEN null;
-- END $$;--> statement-breakpoint
DO $$ BEGIN
...
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "connections_org_status_idx" ON "connections" USING btree ("orgId","disconnectedAt","lastPingAt");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "connections_client_version_idx" ON "connections" USING btree ("clientVersion");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "events_org_status_timestamp_idx" ON "events" USING btree ("orgId","status","timestamp");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "events_webhook_status_idx" ON "events" USING btree ("webhookId","status");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "events_pending_idx" ON "events" USING btree ("timestamp") WHERE "events"."status" = 'pending';
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "forwarding_executions_rule_idx" ON "forwardingExecutions" USING btree ("ruleId");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "forwarding_executions_event_idx" ON "forwardingExecutions" USING btree ("eventId");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "forwarding_executions_created_idx" ON "forwardingExecutions" USING btree ("createdAt");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "forwarding_rules_webhook_active_idx" ON "forwardingRules" USING btree ("webhookId","isActive");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "forwarding_rules_priority_idx" ON "forwardingRules" USING btree ("priority");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "requests_webhook_id_idx" ON "requests" USING btree ("webhookId");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "requests_event_id_idx" ON "requests" USING btree ("eventId");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "requests_org_status_timestamp_idx" ON "requests" USING btree ("orgId","status","timestamp");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "requests_connection_timestamp_idx" ON "requests" USING btree ("connectionId","timestamp");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "requests_slow_idx" ON "requests" USING btree ("timestamp") WHERE "requests"."responseTimeMs" > 1000;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "requests_pending_idx" ON "requests" USING btree ("timestamp") WHERE "requests"."status" = 'pending';
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "webhook_access_requests_webhook_status_idx" ON "webhookAccessRequests" USING btree ("webhookId","status");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "webhook_access_requests_requester_idx" ON "webhookAccessRequests" USING btree ("requesterId");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "webhook_access_requests_pending_expires_idx" ON "webhookAccessRequests" USING btree ("expiresAt") WHERE "webhookAccessRequests"."status" = 'pending';
--> statement-breakpoint
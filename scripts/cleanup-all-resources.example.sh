...
# Example script for running the complete resource cleanup
# This script shows how to set up the environment and run the cleanup

set -e  # Exit on any error

echo "🧹 Unhook Complete Resource Cleanup Example"
echo "==========================================="
echo ""
...
if [ -z "$STRIPE_SECRET_KEY" ]; then
    ...
    echo "   Please set it with: export STRIPE_SECRET_KEY=your_stripe_secret_key"
    exit 1
fi

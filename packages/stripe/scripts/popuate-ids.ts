...
const LOOKUP_KEY_MAPPINGS = {
  unhook_dedicated_support_2025_01_monthly: {
    name: 'DEDICATED_SUPPORT',
    type: 'product',
  },
  unhook_dedicated_support_2025_01_yearly: {
    name: 'DEDICATED_SUPPORT',
    type: 'product',
  },
  // Product mappings
  unhook_free_2025_01_monthly: { name: 'FREE_PLAN', type: 'product' },
  unhook_team_2025_01_monthly: { name: 'TEAM_PLAN', type: 'product' },
  unhook_team_2025_01_yearly: { name: 'TEAM_PLAN', type: 'product' },
} as const;
